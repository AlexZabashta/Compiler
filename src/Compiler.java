...
import tmpast.token.Token;
import tmpast.token.VarToken;
        ...
        try {
            ...
            while (!queue.isEmpty()) {
                ...
                if (pacs.add(pac)) {
                    ...
                    BadToken bt = BracketsTree.build(list, errors);
                    ...
                    BadToken ct = CommaTree.build(bt, errors);
                    ...
                    BadToken kt = KeyWordsTree.build(ct, errors);
                    ...
                    BadToken ot = OperatorTree.build(kt, errors);
