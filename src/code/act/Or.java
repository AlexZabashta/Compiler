...
public class Or extends Action {
    ...
    public Or(LocalVariable res, LocalVariable x, LocalVariable y, String comment) throws TypeMismatch {
        super(null, comment);
